                        ...
                        <div className="flex gap-2 mt-6 justify-center flex-wrap">
                            {stories.map((_, index) => (
                                <button
                                    ...
                                    className={`h-2 transition-all ${index === currentStory
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-2 gap-4">
                            {stories.map((stry, index) => (
                                <div
                                    ...
                                    className={`relative h-40 sm:h-48 rounded-lg overflow-hidden cursor-pointer group transition-transform hover:scale-105 ${index === currentStory ? 'ring-2 ring-himachali-red' : ''
                                        }`}
                                >
                                    <img
                                        src={stry.image}
